...
public class Main {
    ...
    private static void procesarPoliedros(List<Poliedro> arrayList, int numero) {
        ...
        System.out.println("");
        System.out.println("El poliedro de volumen maximo es el " + max);
        System.out.println("El poliedro de volumen minimo es el " + min);
        System.out.println("");
    ...
    private static void invocarMetodosEspecificos(Poliedro poliedro) {
        ...
        if (poliedro instanceof Icosaedro) {
            System.out.println("El area del icosaedro es = " + ((Icosaedro) poliedro).calcularArea());
        }
    }
